...
func flip_footprint() -> void:
	if $PrimarySprite.visible == true:
		...
		$TitleLabel.position = Vector2(-70, -125)
		$"Ports/Output 1".position = Vector2(104, 1)
		$"Ports/Input 1".position = Vector2(63, 353)
		$"Ports/Input 2".position = Vector2(91, 353)
		$"Ports/Input 3".position = Vector2(117, 353)
		$"Ports/Input 4".position = Vector2(146, 353)
		$Ports.position = Vector2(-96, -192)
		$Recipe.position = Vector2(-72, -84)
		$outputBox.position = Vector2(-15, -160)
		$Input1Box.position = Vector2(-63, 142)
		$Input2Box.position = Vector2(-31, 142)
		$Input3Box.position = Vector2(1, 142)
		$Input4Box.position = Vector2(33, 142)
