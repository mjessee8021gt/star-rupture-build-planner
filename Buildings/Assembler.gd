...
func flip_footprint() -> void:
	if $PrimarySprite.visible == true:
		...
		$TitleLabel.position = Vector2(122, 87)
		$"Ports/Output 1".position = Vector2(177, 1)
		$"Ports/Input 1".position = Vector2(1, 366)
		$"Ports/Input 2".position = Vector2(113, 366)
		$"Ports/Input 3".position = Vector2(233, 366)
		$"Ports/Input 4".position = Vector2(352, 366)
		$Recipe.position = Vector2(120, 149)
		$outputBox.position = Vector2(177, 19)
		$Input1Box.position = Vector2(1, 347)
		$Input2Box.position = Vector2(113, 347)
		$Input3Box.position = Vector2(233, 366)
		$Input4Box.position = Vector2(352, 366)
		...
		$TitleLabel.position = Vector2(26, 87)
		$"Ports/Output 1".position = Vector2(81, 1)
		$"Ports/Input 1".position = Vector2(1, 366)
		$"Ports/Input 2".position = Vector2(51, 366)
		$"Ports/Input 3".position = Vector2(103, 366)
		$"Ports/Input 4".position = Vector2(161, 366)
		$Recipe.position = Vector2(24, 149)
		$outputBox.position = Vector2(81, 19)
		$Input1Box.position = Vector2(1, 347)
		$Input2Box.position = Vector2(51, 347)
		$Input3Box.position = Vector2(103, 347)
		$Input4Box.position = Vector2(161, 347)
