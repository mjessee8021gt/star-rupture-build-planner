...
func flip_footprint() -> void:
	if $PrimarySprite.visible == true:
		...
		$TitleLabel.position = Vector2(80, 64)
		$"Ports/Output 1".position = Vector2(94,1)
		$"Ports/Input 1".position = Vector2(1,203)
		$"Ports/Input 2".position = Vector2(187, 203)
		$Recipe.position = Vector2(65, 95)
		$outputBox.position = Vector2(95, 23)
		$outputBox/outputText.position = Vector2(-1, -2)
		$Input1Box.position = Vector2(1, 183)
		$Input1Box/input1Text.position = Vector2(-1, -2)
		$Input2Box.position = Vector2(188, 183)
		...
		$TitleLabel.position = Vector2(64, 64)
		$"Ports/Output 1".position = Vector2(78, 1)
		$"Ports/Input 1".position = Vector2(1, 171)
		$"Ports/Input 2".position = Vector2(155, 171)
		$Recipe.position = Vector2(49, 95)
		$outputBox.position = Vector2(79, 23)
		$outputBox/outputText.position = Vector2(-1, -2)
		$Input1Box.position = Vector2(1, 152)
		$Input1Box/input1Text.position = Vector2(-1, -2)
		$Input2Box.position = Vector2(155, 152)
		$Input2Box/input2Text.position = Vector2(-1, -2)
