...
func flip_footprint() -> void:
	if $PrimarySprite.visible == true:
		...
		$"Ports/Universal 2".position = Vector2(43, 1)
		$"Ports/Universal 3".position = Vector2(70, 1)
		$"Ports/Universal 4".position = Vector2(99, 1)
		$"Ports/Universal 5".position = Vector2(127, 1)
		$"Ports/Universal 6".position = Vector2(70, 104)
		is_alternate = true
		...
		$"Ports/Universal 6".position = Vector2(39, 40)
		is_alternate = false
