...
func flip_footprint() -> void:
	if $PrimarySprite.visible == true:
		...
		$TitleLabel.position = Vector2(51, 67)
		$"Ports/Universal 1".position = Vector2(78, 1)
		$"Ports/Universal 2".position = Vector2(191, 78)
		$"Ports/Universal 3".position = Vector2(78, 171)
		$"Ports/Universal 4".position = Vector2(21, 78)
		...
		$TitleLabel.position = Vector2(18, 22)
		$"Ports/Universal 1".position = Vector2(45, 1)
		$"Ports/Universal 2".position = Vector2(127, 46)
		$"Ports/Universal 3".position = Vector2(45, 107)
		$"Ports/Universal 4".position = Vector2(21, 46)
