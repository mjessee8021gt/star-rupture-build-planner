...
func flip_footprint() -> void:
	if $PrimarySprite.visible == true:
		...
		$TitleLabel.position = Vector2(131, 100)
		$"Ports/Output 1".position = Vector2(208, 1)
		$"Ports/Input 1".position = Vector2(1, 430)
		$"Ports/Input 2".position = Vector2(209, 430)
		$"Ports/Input 3".position = Vector2(417, 430)
		$Recipe.position = Vector2(144, 174)
		$outputBox.position = Vector2(208, 18)
		$Input1Box.position = Vector2(1, 410)
		$Input2Box.position = Vector2(209, 410)
		$Input3Box.position = Vector2(417, 410)
		...
		$TitleLabel.position = Vector2(102, 86)
		$"Ports/Output 1".position = Vector2(176, 1)
		$"Ports/Input 1".position = Vector2(1, 367)
		$"Ports/Input 2".position = Vector2(177, 367)
		$"Ports/Input 3".position = Vector2(353, 367)
		$Recipe.position = Vector2(112, 160)
		$outputBox.position = Vector2(176, 18)
		$Input1Box.position = Vector2(1, 347)
		$Input2Box.position = Vector2(177, 347)
		$Input3Box.position = Vector2(353, 347)
