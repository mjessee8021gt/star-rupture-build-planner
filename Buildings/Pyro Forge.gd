...
func flip_footprint() -> void:
	if $PrimarySprite.visible == true:
		...
		$"Ports/Output 1".position = Vector2(106, -127)
		$outputBox.position = Vector2(-18, -186)
		$"Ports/Input 1".position = Vector2(95, 283)
		$Input1Box.position = Vector2(-36, 167)
		$"Ports/Input 2".position = Vector2(117, 283)
		...
		$"Ports/Output 1".position = Vector2(106, -95)
		$outputBox.position = Vector2(-18, -154)
		$"Ports/Input 1".position = Vector2(95, 251)
		$Input1Box.position = Vector2(-36, 135)
		$"Ports/Input 2".position = Vector2(117, 251)
